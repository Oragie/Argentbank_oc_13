...
function Signin() {
  ...
  const { handleLogin, error } = useLoginAndGetUser();
  ...
  const handleSubmit = async (e) => {
    ...
    // Si la case est cochée, sauvegarder l'email dans le localStorage
    // Sinon, le supprimer
    if (rememberMe) {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="input-remember">
              <input
                ...
                id="remember-me"
                name="rememberMe"
                defaultChecked={savedEmail ? true : false} // Si un email est sauvegardé, la case sera cochée
              />
